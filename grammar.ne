...
hierarchical_location_declaration
  ->	location_cluster {% p.hierarchical_location_declaration_cluster %}
  |	location_cluster WS "." WS hierarchical_location_declaration {% p.hierarchical_location_declaration_cluster_and_location %}
...
location_cluster -> "{" WS cluster_elements WS "}" {% p.location_cluster %}
...
cluster_elements
  ->	identifier {% p.cluster_elements_single %}
  |	identifier WS "," WS cluster_elements {% p.cluster_elements_multiple %}
